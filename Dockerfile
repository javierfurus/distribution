...
RUN apt-get install -y \
    bc default-jre file gawk gcc git golang-1.22-go gperf libjson-perl libncurses5-dev \
    ...
    xmlstarlet rsync bzip2 xz-utils \
    && ln -sf /usr/lib/go-1.22 /usr/lib/go \
    && ln -sf /usr/lib/go-1.22/bin/go /usr/bin/go \
    && ln -sf /usr/lib/go-1.22/bin/gofmt /usr/bin/gofmt
